...
const InitialSetupModal = () => {
  ...
  const [fotoPerfil, setFotoPerfil] = useState(user?.foto_perfil || user?.avatar_url || '');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateProfile({
        ...
        weight_kg: pesoNum,
        height_cm: alturaNum,
        foto_perfil: fotoPerfil.trim() || user?.foto_perfil || user?.avatar_url || null,
        avatar_url: fotoPerfil.trim() || user?.foto_perfil || user?.avatar_url || null
      });
    } catch (err) {
